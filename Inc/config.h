...
*/
 ...
 //#define PRI_INPUT2            3, 0, 0, 4095, 0      // TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
   #define PRI_INPUT1            2, 0, 2047, 4095, 0      // TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
   #define PRI_INPUT2            2, 0, 2047, 4095, 0      // TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
  #ifdef DUAL_INPUTS
...
// ############################# PID CONTROL SETTINGS ################################
  #define PID_CONTROL   //uncomment to use PID control
	 ...
	 #define KP  1.5
	 #define KI  1.
   #define KD  0.   // Добавляем коэффициент D
	 #define PIDDZ 2
	 #define PIDLIM  360
	 typedef struct 
     {
 ...
 * https://gist.github.com/peterpoetzi/18шш2b63a4a844162196613871767189bd05
*/
